...
#Collision with the ball and paddles, how the ball moves after colliding
...
#Defining the keys and not letting them move off screen
...
def main():
    ...
    while run:
        ...
        #Calling the ball to move, collision
        ball.move()
